...
namespace :openai do
    desc "Process OpenAI API and generate CSV"
    task submit: :environment do
      puts "Processing OpenAI API..."
      file_name = '408417'
      image_path = "./lib/assets/illustrator/#{file_name}.png"
      ...
      if File.exist?(image_path)
        ...
        begin
          ...
          csv_file_path = Rails.root.join('./lib/assets/csv/after', "#{file_name}.csv")
